...
const Footer = () => {
  return (
    <div className="bg-primary py-24">
      <div className="wrap grid lg:grid-cols-3 md:grid-cols-2 gap-10 md:gap-20 lg:gap-10">
        <div className="flex flex-col text-gray-200 col-span-1">
          <div>
            <img src={logo} alt="" className="w-20" />
          </div>
          <h2 className="text-2xl pt-4 pb-5">
        ...
        <div className="text-gray-200 lg:pl-4">
          <h3 className="pb-5 font-semibold text-lg text-cente">
            RADIO/TV PROGRAMS
          </h3>
