...
const Question = () => {
  return (
    <div id="question" className="relative bg-[url('/assets/question.jpg')] bg-cover bg-center py-60 text-white">
      <div className="bg-[rgba(38,41,77,0.8)] inset-0 absolute lg:px-24 md:px-16 px-8 flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-20 justify-center items-center ">
        <div className="">
