...
const steps = [
  {
    ...
    text: <>Salvation begins with <span className="font-semibold uppercase">hearing</span> the Word of God. The gospel is the power of God unto salvation for all who believe.</>,
  ...
  },
  {
    ...
    icon: faHandsPraying,
    title: "Believe",
    text: <>We must <span className="font-semibold uppercase">believe</span> that Jesus is the Son of God who died for our sins and rose again on the third day.</>,
  ...
  },
  {
    ...
    icon: faCross,
    title: "Repent",
    text: <><span className="font-semibold uppercase">Repentance</span> is a turning away from sin and a turning toward God with a sincere desire to live for Him.</>,
  ...
  },
  {
    ...
    text: <>With the heart one believes unto righteousness, and with the mouth <span className="font-semibold uppercase">confession</span> is made unto salvation.</>,
  ...
  },
  {
    ...
    icon: faDroplet,
    title: "Be Baptized",
    text: <><span className="font-semibold uppercase">Baptism</span> by immersion in water is for the remission of sins. It is the point at which God washes away our sins and adds us to His church.</>,
